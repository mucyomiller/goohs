						...
						<div class="col-md-3 col-sm-4 col-xs-12">
							...
							<ul class="list-unstyled address-list">
								<li class="clearfix address">
									...
									Kigali Rwanda, Rou de l'armee  UR-CST.
								</li>
								<li class="clearfix">
									<i class="fa fa-fax"></i>
									(250) - 7xx xxx xxx
								...
								<li class="clearfix">
									...
									<a href="mailto:info@goohs.com">info@goohs.com</a>
								</li>
							</ul>
						</div>
		...
		<!-- Copyright Starts -->
			<div class="copyright">
				<div class="container clearfix">
					<p class="pull-left">
						&copy; Copyright 2016. AlL Rights Reserved By <span>Computer Techs Geeks</span>
					</p>
