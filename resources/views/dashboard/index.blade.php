        ...
        <ul class="nav quick-section ">
          <li class="quicklinks"> <a data-toggle="dropdown" class="dropdown-toggle  pull-right " href="#" id="user-options">
            ...
            <ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
              ...
              <li><a href="#"> My Messages&nbsp;&nbsp;<span class="badge badge-important animated bounceIn">2</span></a> </li>
              <li class="divider"></li>
  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      ...
      <ul>
        ...
        <li class=""> <a href="#"> <i class="fa fa-envelope"></i> <span class="title">show Messages</span> <span class=" badge badge-disable pull-right ">203</span></a> </li>
      </ul>
      <div class="clearfix"></div>
      <!-- END SIDEBAR MENU -->
    </div>
...
<script src="{{ asset('dashboard/assets/plugins/jquery-lazyload/jquery.lazyload.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('dashboard/assets/plugins/jquery-scrollbar/jquery.scrollbar.min.js')}}" type="text/javascript"></script>
<!-- END CORE JS FRAMEWORK -->
<!-- BEGIN PAGE LEVEL JS -->
<script src="{{ asset('dashboard/assets/plugins/jquery-slider/jquery.sidr.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('dashboard/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('dashboard/assets/plugins/jquery-ricksaw-chart/js/raphael-min.js')}}"></script>
<script src="{{ asset('dashboard/assets/plugins/jquery-ricksaw-chart/js/d3.v2.js')}}"></script>
<script src="{{ asset('dashboard/assets/plugins/jquery-ricksaw-chart/js/rickshaw.min.js')}}"></script>
<script src="{{ asset('dashboard/assets/plugins/jquery-sparkline/jquery-sparkline.js')}}"></script>
<script src="{{ asset('dashboard/assets/plugins/skycons/skycons.js')}}"></script>
<script src="{{ asset('dashboard/assets/plugins/owl-carousel/owl.carousel.min.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
<script src="{{ asset('dashboard/assets/plugins/jquery-gmap/gmaps.js')}}" type="text/javascript"></script>
<script src="{{ asset('dashboard/assets/plugins/Mapplic/js/jquery.easing.js')}}" type="text/javascript"></script>
<script src="{{ asset('dashboard/assets/plugins/Mapplic/js/jquery.mousewheel.js')}}" type="text/javascript"></script>
<script src="{{ asset('dashboard/assets/plugins/Mapplic/js/hammer.js')}}" type="text/javascript"></script>
<script src="{{ asset('dashboard/assets/plugins/Mapplic/mapplic/mapplic.js')}}" type="text/javascript"></script>
    
<script src="{{ asset('dashboard/assets/plugins/jquery-flot/jquery.flot.js')}}" type="text/javascript"></script>
<script src="{{ asset('dashboard/assets/plugins/jquery-flot/jquery.flot.resize.min.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('dashboard/assets/js/dashboard_v2.js')}}" type="text/javascript"></script>
